...
-->
  ...
  width: 100px">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><?php if(Route::has('login')): ?>
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    <?php if(auth()->guard()->check()): ?>
                        <a  href="<?php echo e(url('/dashboard')); ?>" class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"><p>Hi, <?php echo e(Auth::user()->name); ?></p></a>
                    <?php else: ?>
                        ...
                        <?php if(Route::has('register')): ?>
                            <a href="<?php echo e(route('register')); ?>" class="ml-4 font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Log in</a>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            <?php endif; ?></li> 
...
</html><?php /**PATH C:\Users\acer\Desktop\laravel final\ecosolarpower\resources\views/home.blade.php ENDPATH**/ ?>